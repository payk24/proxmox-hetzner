...
curl -L "https://github.com/payk24/proxmox-hetzner/raw/main/files/main_vmbr0_basic_template.txt" -o ~/interfaces_sample
...
MAIN_IPV6="$(echo "$MAIN_IPV6_CIDR" | cut -d'/' -f1)"

sed -i "s|#IFACE_NAME#|$IFACE_NAME|g" ~/interfaces_sample
sed -i "s|#MAIN_IPV4#|$MAIN_IPV4|g" ~/interfaces_sample
sed -i "s|#MAIN_IPV4_GW#|$MAIN_IPV4_GW|g" ~/interfaces_sample
sed -i "s|#MAIN_IPV6#|$MAIN_IPV6|g" ~/interfaces_sample
